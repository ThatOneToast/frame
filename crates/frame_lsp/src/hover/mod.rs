...
fn declaration_kind_label(kind: &frame_core::symbols::SymbolKind) -> &'static str {
    ...
    match kind {
        ...
        SymbolKind::Declaration(frame_core::DeclarationKind::Layout) => "layout",
        SymbolKind::Declaration(frame_core::DeclarationKind::Motion) => "motion",
        SymbolKind::Declaration(frame_core::DeclarationKind::Recipe) => "recipe",
